...
const depused = require('./subtasks/depused');
const struct = require('./subtasks/struct');
...
module.exports = (grunt) => {
  ...
  grunt.registerMultiTask('gardener', function () {
    ...
    // update package.json
    grunt.registerTask('gardener_package', () => {
    ...
    grunt.registerTask('gardener_structure', function () {
      ...
      struct(grunt, options.cwd, loadConfig(".structignore")).then(done);
    });
