...
#### :open_file_folder: <a name="blackfluxrobo-config-plugin-task-ref-circlecinpm-default">circleci/#npm-default</a> (<a href="#blackfluxrobo-config-plugin-task-idx-ref-circlecinpm-default">`index`</a>)
